...
class Patient(models.Model):
    ...
    assignedNurseId = models.PositiveIntegerField(null=True,blank=True)
    assignedDrugsId = models.PositiveIntegerField(null=True,blank=True)
...
class Drugs(models.Model):
    ...
    def get_id(self):
        return self.user.id
    def __str__(self):
        return "{} ({})".format(self.drugname,self.provider)
